...
"""
    ABOUT_TEXT = """
- **Bot :** `TY-Yotuberbot`
- **Creator :** [Khalil](https://telegram.me/Ho0000s)
- **Channel :** [مرجوج للمعلوميات](https://telegram.me/Y5_M5)
- **Credits :** `Everyone in this journey`
- **Source :** [Click here](https://github.com/khalilThabit/Ty-yotuberbot)
...
"""
    START_BUTTONS = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton('Channel', url='https://telegram.me/Y5_M5'),
        InlineKeyboardButton('Feedback', url='https://telegram.me/Ho0000s')
        ],[
...
URL | newfilename | username | password"""
    ...
    CUSTOM_CAPTION_UL_FILE = "<b>Join :-</b> @Y5_M5"
